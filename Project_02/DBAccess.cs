...
namespace Project_02
{
    internal class DBAccess
    {
        ...
        {
            string strConn = $"server = {SERVER};username = {USERNAME};password = {PASSWORD};database = {DATABASE};";
        ...
        public void InsertUser(string uid, string name, string hp, string age)
        {
            ...
            MessageBox.Show("데이터가 추가 되었습니다.", "Insert 완료");
        }
        ...
        public void UpdateUser(string uid, string name, string hp, string age)
        {
            ...
            MessageBox.Show("데이터가 수정 되었습니다.", "Update 완료");
        }
        ...
        public void DeleteUser(string uid)
        {
            ...
            MessageBox.Show("데이터가 삭제 되었습니다.", "Delete 완료");
